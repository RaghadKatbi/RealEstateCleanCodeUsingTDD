                      ...
                      itemBuilder: (context, index) => Card(
                        ...
                        child: Column(
                          children: [
                            Stack(
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    "https://proengaqar.com/img/temp/${state.estateAddedByUser[index].image}",
                                    height: 200,
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          ...
                                          state.estateAddedByUser[index].status,
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    state.estateAddedByUser[index].propertyType,
                                    style: TextStyle(
                                      fontSize: 18,
                                      color: Colors.grey,
                                      fontFamily: 'cairo',
                                  ...
                                  Text(state.estateAddedByUser[index].location,
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontFamily: 'cairo',
                                      )),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${state.estateAddedByUser[index].rooms }  Rooms",
                                          style: TextStyle(
                                            color: Colors.white,
                                            fontFamily: 'cairo',
                                          ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${state.estateAddedByUser[index].bathrooms } Bathroom",
                                          style: TextStyle(
                                            color: Colors.white,
                                            fontFamily: 'cairo',
                                          ),
                            ...
                            state.estateAddedByUser[index].reason!="0" ?  Container(
                              child:
                                  Text("${state.estateAddedByUser[index].reason}"),
                              color: Colors.red,
                            ): Container(),
                          ],
                        ),
