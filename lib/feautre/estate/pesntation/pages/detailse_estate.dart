        ...
        body: PopScope(
          ...
          onPopInvoked: (didPop) {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => MyBottomNavigationBar(7, "", 0),
                ));
          },
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Wrap(children: [
                          Row(
                            ...
                            children: [
                              IconButton(onPressed: () {
                                ...
                                builder: (context, state) {
                                  return Icon(
                                    state is UserEstateSuccessSetOrUnSet &&
                                            state.isFav
                                        ? Icons.favorite
                          ...
                          Container(
                            child: Padding(
                              padding: EdgeInsets.only(
                                  right: 0, top: 8, bottom: 8, left: 60),
                              child: Text(
                                " ${state.estate.description}",
                                style: TextStyle(
                                    fontSize: 15, fontFamily: 'chnanges'),
                          ...
                          MyCustomText(
                            text:
                                "موقع العقار : ${state.estate.neighborhood.name}",
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                          ),
                          const SizedBox(
                          ...
                          MyCustomText(
                            text: state.estate.buildingRank == 1
                                ? "الامان : مفحوص من قبل شركة Building Rank "
                                : "الامان :غير مفحوص من قبل شركة Building Rank ",
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                          ),
                          const SizedBox(
                          ...
                          MyCustomText(
                            text: "عدد المشاهدات : ${state.estate.numberShow} ",
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                          ),
                          const SizedBox(
